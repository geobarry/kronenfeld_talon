...
## user / kronenfeld
 ...
 - **focus contents top item**  `user.click_element_by_name("search")
		sleep(1.5)
 ...
 - **list by data source**  `user.mouse_helper_position_save()
 ...
 - **focus Geoprocessing**  `key(alt-v c t)
		sleep(0.25)
		key(alt-v t s)
		sleep(0.25)
 ...
 - **menu insert**  `key(esc:5)
		key(alt)
		sleep(0.2)
		key(n)`

 - **menu analysis**  `key(esc:5)
		key(alt)
		sleep(.2)
		key(a)`
 ...
 - **menu imagery**  `key(esc:5)
		key(alt)
		sleep(0.2)
		key(i)`

 - **menu share**  `key(esc:5)
		key(alt)
		sleep(0.2)
		key(s)`

 - **menu (layout|lay out)**  `key(esc:5)
		key(alt)
		sleep(0.2)
		key(y)`

 - **menu table**  `key(esc:5)
		key(alt)
		sleep(0.2)
		key(t)
		key(v)`

 - **menu lay out**  `key(esc:5)
		key(alt)
		sleep(0.2)
		key(j l)`
 ...
 - **select by attributes**  `key(esc:5)
		key(alt)
		sleep(0.2)
		key(m s b a)`
...
## user / kronenfeld
 ...
 - **menu select**  `key(alt-s)`

 - **menu view**  `key(alt-v)`

 - **menu image**  `key(alt-i)`

 - **menu layer**  `key(alt-l)`

 - **menu colors**  `key(alt-c)`

 - **menu tools**  `key(alt-t)`

 - **menu filters**  `key(alt-r)`

 - **menu windows**  `key(alt-w)`
...
## user / kronenfeld
 ...
 - **(insert|new) slide**  `key(alt)
		sleep(0.2)
		key(h i)`

 - **slide layout**  `key(alt)
		sleep(0.2)
		key(h l)`
 ...
 - **font color white**  `key(alt)
		sleep(0.2)
		key(h f c enter)`

 - **font color red**  `key(alt)
		sleep(0.2)
		key(h f c down:6 enter)`

 - **font color black**  `key(alt)
		sleep(0.2)
		key(h f c right enter)`

 - **font color teal**  `key(alt)
		sleep(0.2)
 ...
 - **apply (italic|italics)**  `key(alt)
		sleep(0.2)
		key(h 2)`

 - **apply underline**  `key(alt)
		sleep(0.2)
		key(h 53)`
 ...
 - **apply bullets**  `key(alt)
		sleep(0.3)
		key(h u)`

 - **apply bullets none**  `key(alt)
		sleep(0.3)
		key(h u left:12 enter)`

 - **apply (default bullets|bullets default)**  `key(alt)
		sleep(0.3)
		key(h u left:12 right enter)`

 - **apply numbers**  `key(alt)
		sleep(0.3)
		key(h n)`

 - **apply numbers [with] dots**  `key(alt)
		sleep(0.3)
		key(h n)
		key(left:12)
		key(right)
 ...
 - **paragraph formatting**  `key(alt)
		sleep(0.3)
		key(h p g)
		`

 - **(indent|demote)**  `key(alt)
		sleep(0.2)
		key(h)
		sleep(0.2)
		key(z p a i)`

 - **(dedent|promote)**  `key(alt)
		sleep(0.3)
		key(h z p a o)`
 ...
 - **fill color**  `key(alt-h)
		sleep(0.05)
		key(s)
		key(f)
		key(down:6)`

 - **fill transparent**  `key(alt-h)
		sleep(0.05)
		key(s)
		key(f)
		key(n)`

 - **outline color**  `key(alt-h)
		sleep(0.05)
		key(s)
		key(o)
		key(down:6)`

 - **outline [color] red**  `key(alt-h)
		sleep(0.05)
		key(s)
		key(o)
		key(down:6)
 ...
 - **outline width**  `key(alt-h)
		sleep(0.05)
		key(s)
		key(o)
		key(w)`

 - **outline width one**  `key(alt-h)
		sleep(0.05)
		key(s)
		key(o)
		key(w)
 ...
 - **rotate right**  `key(alt-h)
		sleep(0.05)
		key(g)
		key(o)
		key(r)`

 - **rotate left**  `key(alt-h)
		sleep(0.05)
		key(g)
		key(o)
		key(l)`

 - **flip vertical**  `key(alt-h)
		sleep(0.05)
		key(g)
		key(o)
		key(v)`

 - **flip horizontal**  `key(alt-h)
		sleep(0.05)
		key(g)
		key(o)
		key(h)
 ...
 - **[insert] text box**  `key(alt-n)
		sleep(0.05)
		key(x)
		key(h)`

 - **insert [hyper] link**  `key(alt-n)
		sleep(0.05)
		key(z)
		key(l)
		key(i:2)`

 - **insert icon**  `key(alt-n)
		sleep(0.05)
		key(n)
		key(s)
		sleep(0.5)
 ...
 - **insert rectangle**  `key(alt-n s h)
		sleep(0.05)
		key(right:4 enter)`

 - **insert table**  `key(alt-n t)`

 - **[insert] rounded rectangle**  `key(alt-n)
		sleep(0.05)
		key(s)
		key(h)
		sleep(0.05)
 ...
 - **record current slide**  `key(alt-c)
		sleep(0.05)
		key(c)
		key(s)
		user.activate_power_recording()`

 - **record screen**  `key(alt-c)
		sleep(0.05)
		key(r)
		key(1)
		user.activate_power_screen_recording()`

 - **insert cameo**  `key(alt-c)
		sleep(0.05)
		key(c)
		key(1)
 ...
 - **clear (transition|timing)**  `key(alt-k)
		key(i)
		insert("0")
		key(enter)
		key(esc)
 ...
 - **apply animation**  `key(alt-a)
		key(s)
		key(pageup:3)
		`

 - **apply animation fade**  `key(alt-a)
		key(s)
		key(pageup:3)
		key(down)
		key(right)
 ...
 - **apply animation appear**  `key(alt-a)
		key(s)
		key(pageup:3)
		key(down)
		key(enter)`

 - **apply animation wipe [right]**  `key(alt-a)
		key(s)
		key(pageup:3)
		key(down)
		key(right:5)
 ...
 - **animation panel**  `key(alt-a)
		key(c)`

 - **exit animation panel**  `key(esc)
		key(alt-a)
		key(c)
		
		#slide show menu`

 - **present slide show**  `key(alt-s)
		sleep(0.05)
		key(b)`

 - **present current slide**  `key(alt-s)
		sleep(0.05)
		key(c)
		
		#view menu`

 - **slide sorter**  `key(alt-w)
		key(i)`

 - **outline view**  `key(alt-w)
		key(p)
		key(o)`

 - **normal view**  `key(alt-w)
		key(l)`

 - **(master view|slide master)**  `key(alt-w)
		key(m)`

 - **rename [slide] layout**  `key(alt-m)
		key(r)`

 - **close (master [view]|slide master)**  `key(alt-m)
		key(c)
		`
 ...
 - **shape [fill] transparency**  `key(alt)
		sleep(0.05)
		key(j)
		key(d)
		key(s)
 ...
 - **shape [fill] transparency <number>**  `key(alt)
		sleep(0.05)
		key(j)
		key(d)
		key(s)
 ...
 - **shape width <number> point <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(d)
		key(w)
 ...
 - **shape height**  `key(alt)
		sleep(0.08)
		key(j)
		key(d)
		key(h)`

 - **shape height <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(d)
		key(h)
 ...
 - **shape height <number> point <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(d)
		key(h)
 ...
 - **shape position**  `# first need to collapse all menus
		key(alt)
		sleep(0.08)
		key(j)
		key(d)
 ...
 - **insert column before**  `key(alt)
		sleep(0.05)
		key(j)
		key(l)
		key(l)`

 - **insert column after**  `key(alt)
		sleep(0.05)
		key(j)
		key(l)
		key(i)`
 ...
 - **picture width**  `key(alt)
		sleep(0.08)
		key(j)
		key(p)
		key(w)`

 - **picture width <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(p)
		key(w)
 ...
 - **picture width <number> point <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(p)
		key(w)
 ...
 - **picture height <number> point <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(p)
		key(h)
 ...
 - **picture position**  `# first need to collapse all menus
		key(alt)
		sleep(0.08)
		key(j)
		key(p)
 ...
 - **[picture] transparent color**  `key(alt)
		sleep(0.08)
		key(j)
		key(p)
		key(i)
 ...
 - **graphics width**  `key(alt)
		sleep(0.08)
		key(j)
		key(g)
		key(w)`

 - **graphics width <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(g)
		key(w)
 ...
 - **graphics width <number> point <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(g)
		key(w)
 ...
 - **graphics height**  `key(alt)
		sleep(0.08)
		key(j)
		key(g)
		key(h)`

 - **graphics height <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(g)
		key(h)
 ...
 - **graphics height <number> point <number>**  `key(alt)
		sleep(0.08)
		key(j)
		key(g)
		key(h)
 ...
 - **graphics position**  `# first need to collapse all menus
		key(alt)
		sleep(0.08)
		key(j)
		key(g)
 ...
 - **insert fraction**  `key(alt)
		sleep(0.05)
		key(j)
		key(e)
		key(f)`

 - **insert script**  `key(alt)
		sleep(0.05)
		key(j)
		key(e)
		key(s)`

 - **insert radical**  `key(alt)
		sleep(0.05)
		key(j)
		key(e)
		key(r)`

 - **insert large operator**  `key(alt)
		sleep(0.05)
		key(j)
		key(e)
		key(g)`

 - **equation insert symbol**  `key(alt)
		sleep(0.05)
		key(j)
		key(e)
		key(q)`

 - **insert accent**  `key(alt)
		sleep(0.05)
		key(j)
		key(e)
		sleep(0.05)
 ...
 - **update timing**  `# updates transition timing to length of selected video
		key(alt)
		sleep(0.3)
		key(j)
		key(n)
 ...
 - **duplicate right**  `# first zoom to 82% so that this works
		key(alt-w)
		key(q)
		sleep(0.05)
		key(p)
 ...
 - **duplicate small right**  `# first zoom to 82% so that this works
		key(alt-w)
		key(q)
		sleep(0.05)
		key(p)
...
## user / kronenfeld
 ...
 - **apply style <user.word>**  `user.slow_key_press("alt-h z 1 y 1")
		insert(word)
		sleep(0.1)
		key(enter esc)
		`
...
#  abbreviate 
## user / community / core / abbreviate
...
#  apple notes 
## user / community / apps / apple_notes
...
#  apple terminal 
## user / community / apps / apple_terminal
...
#  cheatsheet 
## user / kronenfeld / CHEAT SHEET


 - **print cheatsheet**  `user.cheatsheet()`

 - **update cheat sheet**  `# replace with "mac" or "linux" if needed
		user.cheatsheet("win")
		sleep(1.5)
		key(super)
		sleep(0.2)
...
#  command history 
## user / community / plugin / command_history
...
#  datetimeinsert 
## user / community / plugin / datetimeinsert
...
#  desktops 
## user / community / plugin / desktops
...
#  draft editor 
## user / community / plugin / draft_editor
...
# win draft global 
## user / community / plugin / talon_draft_window
...
#  dropdown 
## user / community / plugin / dropdown
...
## user / eagle_talon
 ...
 - **eagle display {user.eagle_display_modes}**  `user.display_mode(user.eagle_display_modes)
...
## user / kronenfeld
 ...
 - **save download [as]**  `user.slow_ky_press("ctrl-j tab:2 enter")`
...
#  edit vocabulary 
## user / community / core / vocabulary
...
## user / kronenfeld
 ...
 - **insert checkmark**  `user.unicode_excel_power("00fc","Wingdings")`

 - **insert ex mark**  `user.unicode_excel_power("00fb","Wingdings")`

 - **insert boxed checkmark**  `user.unicode_excel_power("00fe","Wingdings")`

 - **insert boxed ex mark**  `user.unicode_excel_power("00fd","Wingdings")
		`

 - **insert degree symbol**  `user.unicode_excel_power("00b0","Symbol")`

 - **insert double arrow**  `user.unicode_excel_power("00ab","Symbol")`

 - **insert left arrow**  `user.unicode_excel_power("00ac","Symbol")`

 - **insert up arrow**  `user.unicode_excel_power("00ad","Symbol")`

 - **insert right arrow**  `user.unicode_excel_power("00ae","Symbol")`

 - **insert down arrow**  `user.unicode_excel_power("00af","Symbol")`

 - **insert alpha**  `user.unicode_excel_power("03b1")`

 - **insert beta**  `user.unicode_excel_power("03b2")`

 - **insert gamma**  `user.unicode_excel_power("03b3")`

 - **insert delta**  `user.unicode_excel_power("03b4")`

 - **insert capital alpha**  `user.unicode_excel_power("0394")`

 - **insert mu**  `user.unicode_excel_power("03bc")`

 - **insert sigma**  `user.unicode_excel_power("03c3")`

 - **insert pi**  `user.unicode_excel_power("03c0")`

 - **insert lambda**  `user.unicode_excel_power("03bb","Times New Roman")`

 - **insert infinity**  `user.unicode_excel_power("221e", "Times New Roman")`

 - **insert circled <number_small>**  `user.circle_number_excel_power(number_small)`

 - **insert dark circled <number_small>**  `user.dark_circle_number_excel_power(number_small)`
...
## user / kronenfeld
 ...
 - **sort by name**  `# get into the menu
		key(alt)
 ...
 - **sort by date**  `# get into the menu
		key(alt)
		# sort menu is third from the right
		key(right:20)
		key(left:2)
 ...
 - **open jupyter [notebook]**  `# grab path to current folder
		key(alt-d)
		sleep(0.5)
		edit.copy()
...
## user / kronenfeld
 ...
 - **click <user.text>**  `user.move_to_spot(user.text)
		sleep(0.5)
		mouse_click(0)`
...
#  file extension 
## user / community / core / file_extension
...
#  file manager 
## user / community / tags / file_manager
...
#  find and replace 
## user / community / tags / find_and_replace
...
## user / kronenfeld
 ...
 - **computer (wake|start listening|wake up|open your ears)**  `speech.enable()`



#  help 
## user / community / core / help
...
#  homophones 
## user / community / core / homophones
...
## user / kronenfeld
 ...
 - **layer menu**  `key(esc:3)
		key(alt-l)`

 - **object menu**  `key(esc:3)
		key(alt-o)`
 ...
 - **filters menu**  `key(esc:3)
		key(alt-s)`

 - **extensions menu**  `key(esc:3)
		key(alt-n)`
 ...
 - **nudge right**  `key(alt-right)`

 - **nudge left**  `key(alt-left)`

 - **nudge up**  `key(alt-up)`

 - **nudge down**  `key(alt-down)`



#  java 
## user / community / lang / java
...
#  javascript 
## user / community / lang / javascript
...
## user / kronenfeld
 ...
 - **(run|execute) (code|cell)**  `key(shift-enter)`

 - **(run|execute) in place**  `key(shift-enter)
		sleep(0.1)
		key(up)`
 ...
 - **inline command**  `user.insert_between("**<a style='color:#b10;font-family:Courier New,monospace'>","</a>**")`

 - **begin command style**  `insert("**<a style='color:#b10;font-family:Courier New,monospace'>")`

 - **end command style**  `insert("</a>**")`

 - **[insert] line break**  `insert("<br>")`

 - **insert code block**  `user.insert_between("<p style='color:#ee7;font-weight:bold;background-color:#225;font-family:Courier New,monospace;padding: 0.2em'>","</p>")`

 - **begin code block**  `insert("<p style='color:#ee7;font-weight:bold;background-color:#225;font-family:Courier New,monospace;padding: 0.2em'>")`

 - **end code block**  `insert("</p>")`

 - **insert code style**  `user.insert_between("<a style='color:#24b;font-weight:bold;font-family:Courier New,monospace;padding: 0.2em'>","</a>")`

 - **begin code style**  `insert("<a style='color:#24b;font-weight:bold;font-family:Courier New,monospace;padding: 0.2em'>")`

 - **end code style**  `insert("</a>")`

 - **begin comment style**  `insert("<a style='color:#b27;font-style:italic;font-family:Cursive,Brush Script MT;padding: 0.2em'>")`
...
#  line commands 
## user / community / tags / line_commands
...
## user / community / lang / lua
 ...
 - **index (var | variable) <user.text>**  `var = user.formatted_text(text, "snake")
		insert("[{var}]")
		`
...
## user / ui_helper
 ...
 - **marker hide**  `user.marker_ui_hide()
		`

 - **jump <user.marker_ui_label>**  `user.marker_ui_mouse_move(marker_ui_label)
		user.marker_ui_hide()
		`

 - **touch <user.marker_ui_label>**  `user.marker_ui_mouse_move(marker_ui_label)
		mouse_click(0)
		user.marker_ui_hide()
		`

 - **touch <user.marker_ui_label> restore**  `user.mouse_helper_position_save()
 ...
 - **righty <user.marker_ui_label>**  `user.marker_ui_mouse_move(marker_ui_label)
		mouse_click(1)
		user.marker_ui_hide()
		`

 - **midclick <user.marker_ui_label>**  `user.marker_ui_mouse_move(marker_ui_label)
		mouse_click(2)
		user.marker_ui_hide()
 ...
 - **jump <user.marker_ui_label> more**  `user.marker_ui_mouse_move(marker_ui_label)
		`

 - **touch <user.marker_ui_label> more**  `user.marker_ui_mouse_move(marker_ui_label)
		mouse_click(0)
		`

 - **touch <user.marker_ui_label> more restore**  `user.mouse_helper_position_save()
		user.marker_ui_mouse_move(marker_ui_label)
		mouse_click(0)
		user.mouse_helper_position_restore()
		`

 - **righty <user.marker_ui_label> more**  `user.marker_ui_mouse_move(marker_ui_label)
		mouse_click(1)
		`

 - **midclick <user.marker_ui_label> more**  `user.marker_ui_mouse_move(marker_ui_label)
		mouse_click(2)`
...
## user / kronenfeld
 ...
 - **[matplotlib] create Bezier [curve]**  `insert("curve_def = (")
		key(enter:2)
		key(up)
...
## user / community / plugin / microphone_selection
...
#  mouse grid 
## user / community / core / mouse_grid
...
#  multiple cursors 
## user / community / tags / multiple_cursors
...
## user / kronenfeld
 ...
 - **go to line <number>**  `key(ctrl-g)
		sleep(0.1)
		insert("{number}")
		key(enter)`

 - **open workspace**  `key(alt-f)
		key(w)
		key(enter)`

 - **toggle workspace**  `#	key(alt-shift-W)
		key(alt-v)
		key(up:9)
		key(enter)`

 - **focus workspace**  `#	key(alt-shift-W:2)
		key(alt-v)
		key(up:9)
		key(enter)
		key(alt-v)
 ...
 - **repeat <number>**  `insert("repeat({number})")`

 - **open containing folder**  `key(alt-f)
		key(o)
		key(shift-tab:2)
 ...
 - **define function**  `user.insert_between("function ","(){}")`
...
## user / kronenfeld
 ...
 - **exit recording**  `key(esc)
		user.deactivate_power_recording()
		`

 - **toggle teleprompter**  `key(t)`

 - **toggle presenter view**  `key(ctrl-n)`

 - **scroll down**  `key(ctrl-down)`

 - **clear recording**  `key(ctrl-d)`

 - **scroll up**  `key(ctrl-up)`

 - **start recording**  `speech.disable()
		key(r)`

 - **okay moving on**  `speech.enable()`

 - **stop recording**  `key(s)`

 - **retake recording**  `speech.disable()
		key(ctrl-r)
		`



#  power recording sleep mode 
## user / kronenfeld
...
#  power screen recording sleep mode 
## user / kronenfeld
...
#  protonmail 
## user / community / apps / protonmail
...
## user / kronenfeld
 ...
 - **import {user.module_list}**  `insert("import ")
		insert(module_list)`

 - **from {user.module_list} import**  `insert("from ")
		insert(module_list)
		insert(" import ")`

 - **from {user.module_list} import {user.module_list}**  `insert("from ")
		insert(module_list_1)
		insert(" import ")
		insert(module_list_2)`

 - **module {user.module_list}**  `insert(module_list)`
...
## user / kronenfeld
 ...
 - **add (geodatabase|geo database)**  `key(ctrl-shift-v)
		sleep(0.1)
 ...
 - **add shape file**  `key(ctrl-shift-v tab:6)
		sleep(0.2)
		key(space)
		sleep(0.2)
...
#  repeater 
## user / community / plugin / repeater
...
## user / kronenfeld
 ...
 - **show all**  `key("alt-ctrl-shift-0")`

 - **focus source**  `key('ctrl-1')`

 - **zoom source**  `key("alt-ctrl-shift-0")
		key('ctrl-shift-1')`

 - **focus console**  `key('ctrl-2')`

 - **zoom console**  `key("alt-ctrl-shift-0")
		key('ctrl-shift-2')`

 - **run all**  `key("alt-ctrl-r")`

 - **set equal**  `insert(" <- ")`

 - **check equal**  `insert(" = ")`

 - **go to line**  `key("alt-shift-g")`

 - **clear console**  `key("ctrl-l")`

 - **toggle comment**  `key('ctrl-shift-c')`

 - **replace all**  `key('ctrl-shift-J')`



#  ruby 
## user / community / lang / ruby
...
#  screenshot 
## user / community / plugin / screenshot
...
## user / kronenfeld
 ...
 - **<user.key> <number> second repeat**  `user.start_repeating("{key}",number*1000)`

 - **<user.key> <number> (tic|take) repeat**  `user.start_repeating("{key}",number*100)
		
		#short cut for common intervals`

 - **<user.key> slow**  `user.start_repeating("{key}",2500)`

 - **<user.key> steady**  `user.start_repeating("{key}",1500)`

 - **<user.key> quick**  `users.start_repeating("{key}",500)`

 - **<user.key> fast**  `user.start_repeating("{key}",350)`

 - **<user.key> faster**  `user.start_repeating("{key}",200)`

 - **<user.key> lightning**  `user.start_repeating("{key}",100)`
...
## user / kronenfeld
 ...
 - **focus project**  `key(ctrl-shift-p)
 ...
 - **focus outline**  `key(ctrl-shift-o)
		user.mouse_helper_position_save()
		user.mouse_helper_move_image_relative("spyder_hamburger_right_pane.png", 0, -50, 70)
		sleep(0.3)
		mouse_click(0)`

 - **focus (variable|variables)**  `key(ctrl-shift-v)`

 - **focus (interpreter|console)**  `key(ctrl-shift-i)`

 - **focus (plot|plots)**  `key(ctrl-shift-g)
		user.mouse_helper_position_save()
		user.mouse_helper_move_image_relative("spyder_hamburger_right_pane.png", 0, -50, 70)
		sleep(0.05)
		mouse_click(0)
 ...
 - **clear (plot|plots)**  `key(ctrl-shift-g)
		user.mouse_helper_position_save()
		user.mouse_helper_move_image_relative("spyder_hamburger_right_pane.png", 0, -50, 70)
		sleep(0.5)
		mouse_click(0)
 ...
 - **check error**  `user.mouse_helper_position_save()
 ...
 - **format <number> decimal places**  `insert("{:.")
		insert(number_1)
		insert("f}")`
...
# win tabs 
## user / community / core / windows_and_tabs
...
## user / kronenfeld
 ...
 - **activate jupiter [notebook] [tag]**  `user.activate("jupyter_notebook")
		user.activate("my_python")`

 - **deactivate jupiter [notebook] [tag]**  `user.deactivate("jupyter_notebook")
		user.deactivate("python")`

 - **activate fast spots**  `user.activate("fast_spots")`

 - **deactivate fast spots**  `user.deactivate("fast_spots")`

 - **activate zoom**  `user.activate("zoom")`

 - **deactivate zoom**  `user.deactivate("zoom")`

 - **activate teams**  `user.activate("teams")`

 - **deactivate teams**  `user.deactivate("teams")`



#  talon 
## user / community / lang / talon
...
#  talon helpers 
## user / community / plugin / talon_helpers
...
#  talon repl 
## user / community / apps / talon_repl
...
## user / kronenfeld
 ...
 - **unmute**  `key(ctrl-shift-m)
		speech.disable()`



#  terminal 
## user / community / tags / terminal
...
## user / kronenfeld
 ...
 - **show cheat sheet**  `insert("cd %appdata%/Talon/user/cheat sheet")
		key("enter")
		insert("python -m http.server 8080")
		key("enter")
		`

 - **start server**  `insert("python -m http.server 8080")
		`

 - **start server <number>**  `insert("python -m http.server {number}")
		`

 - **start node server**  `insert("npm start")
		key("enter")
		`

 - **conda list environments**  `insert("conda env list")
		key(enter)`

 - **conda install**  `insert("conda install ")`

 - **conda activate**  `insert('activate ')`

 - **conda create**  `insert('conda create ')
		`

 - **open spider app**  `insert('spyder')
		key(enter)
		`

 - **open jupiter notebook**  `insert("jupyter notebook")
		key(enter)
		
		# ffmpeg`

 - **convert clipboard movie**  `insert('ffmpeg -i ')
		edit.paste()
...
## user / kronenfeld
 ...
 - **wake from the dead**  `speech.enable()
		user.talon_mode()
		insert("Brains...")
		speech.disable()
		`
...
#  text navigation 
## user / community / plugin / text_navigation
 ...
 - **select next <user.word>**  `user.navigation_by_string("SELECT","DOWN","word","DEFAULT",word,1)`

 - **select previous <user.word>**  `user.navigation_by_string("SELECT","UP","word","default",word,1)`

 - **extend next <user.word>**  `user.navigation_by_string("EXTENT","DOWN","word","DEFAULT",word,1)
...
#  thunderbird 
## user / community / apps / thunderbird
...
#  typescript 
## user / community / lang / typescript
...
## user / kronenfeld
 ...
 - **greet {user.person_list}**  `insert("Hi {person_list},")
		key(enter:2)`

 - **greet {user.person_list} and {user.person_list}**  `insert("Hi {person_list_1} and {person_list_2},")
		key(enter:2)`

 - **(formal|formally) greet {user.person_list}**  `insert("Dear {person_list},")
		key(enter:2)`

 - **{user.person_list} possessive**  `insert("{person_list}'s ")`

 - **{user.person_list} and others possessive**  `insert("{person_list} et al's ")`

 - **{user.person_list} and others**  `insert("{person_list} et al. ")`

 - **doctor {user.person_list}**  `insert("Dr. {person_list}")`



#  vimscript 
## user / community / lang / vimscript
...
#  visual studio 
## user / community / apps / visualstudio
...
## user / community / core / websites_and_search_engines
...
## user / window-tweak
 ...
 - **window traits show**  `user.win_show_info()
		
		# hide the window information window`

 - **window traits hide**  `user.win_hide_info()
		
		# move the current window toward the center of the screen`

 - **window move**  `user.win_move()
		
		# move the current window in the given direction`

 - **window move <user.compass_direction>**  `user.win_move(compass_direction)
		
		# move the current window some percentage of its own size toward the center of the screen`

 - **window move <number> percent**  `user.win_move_percent(number)
		
		# move the current window some percentage of its own size in the given direction`

 - **window move <user.compass_direction> <number> percent**  `user.win_move_percent(number, compass_direction)
		
		# move the current window some number of pixels toward the center of the screen`

 - **window move <number_signed> pixels**  `user.win_move_pixels(number_signed)
		
		# move the current window some number of pixels in the given direction`

 - **window move <user.compass_direction> <number_signed> pixels**  `user.win_move_pixels(number_signed, compass_direction)
		
		# move the current window to the given coordinates (x at y)`

 - **window move <number_signed> at <number_signed>**  `user.win_move_absolute(number_signed_1, number_signed_2)
 ...
 - **window size <user.non_dual_direction> to pointer**  `user.win_resize_to_pointer(non_dual_direction)
		
		# restore current window's last remembered size and position`

 - **window revert**  `user.win_revert()`



# win window tweak stop 
## user / window-tweak


 - **window stop**  `user.win_stop()`



# win windows explorer 
## user / community / apps / windows_explorer
...
## user / community / apps / windows_terminal
